  ...
  return (
    <PageTransition>
      ...
      <div className="min-h-screen">
        ...
        <section ref={heroRef} className="relative min-h-screen flex items-center justify-center film-grain overflow-hidden">
